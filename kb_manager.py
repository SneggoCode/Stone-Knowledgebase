...
class KBManager:
    ...
    def generate_suggestions(self):
        ...
        prompt = (
            ...
            'answer_text, stone_type, product_form, product_size_mm, '
            'eigenschaft und anwendung. Fehlt eine Information, wähle '
            'eine möglichst passende Kategorie oder lass das Feld leer.'
        )
        try:
